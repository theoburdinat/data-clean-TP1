...
def test_load_formatted_data(sample_dirty_fname, sample_formatted):
    ...
    print(load_formatted_data(sample_dirty_fname)['nom']==sample_formatted['nom'])
    print(load_formatted_data(sample_dirty_fname).loc[7,'nom'])
    print(sample_formatted.loc[7,'nom'])
    assert load_formatted_data(sample_dirty_fname)['nom'].equals(sample_formatted['nom'])
